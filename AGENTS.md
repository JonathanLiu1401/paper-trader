...
15. **`signals._db_path()` is freshness-aware, not existence-first.** It was
   ...
   it) is most recent; USB is still preferred on a tie / when freshness is
   indeterminate (the intentional USB-canonical default). TTL-cached (120s,
